    ...
    <section className="px-8 py-20 mx-auto mt-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="border-4 border-transparent hover:border-orange-500 rounded-3xl shadow-md p-8 flex flex-col items-center w-[384px] h-[475.2px]">
          ...
          <button className="bg-gray-300 hover:bg-orange-600  text-black px-6 py-2 rounded-md w-80 font-semibold">
            Get Started
          </button>
        </div>
        ...
        <div className="border-4 border-orange-500 rounded-3xl shadow-md p-8 flex flex-col items-center w-[384px] h-[475.2px]">
          ...
          <button className="bg-orange-300 hover:bg-orange-600 text-black px-6 py-2 w-80 rounded-md font-semibold">
            Get Started
          </button>
        </div>
        {/* Enterprise Package */}
        <div className="border-4 border-transparent hover:border-orange-500 rounded-3xl shadow-md p-8 flex flex-col items-center w-[384px] h-[475.2px]">
          ...
          <button className="bg-gray-300 hover:bg-orange-600 text-black px-6 py-2 rounded-md font-semibold w-80">
            Contact Sales
          </button>
        </div>
      </div>
