        ...
        <div className="hero-content">
          <div className="hero-left">
            ...
            <h1 className="hero-title">
              Transform Your<br />
              Digital Vision with<br />
              Zoro Innovations
            </h1>
            <div className="hero-description">
              <p>Expert solutions in web development, AI, SaaS, and IT services — crafted to accelerate your growth and digital success.</p>
              <p>Let us help you build smarter systems, scalable platforms, and future-ready innovations.</p>
            </div>
