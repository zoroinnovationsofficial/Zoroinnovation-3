...
const HowWeWork = () => {
  ...
  <div className="process-step">
    ...
    <h3>Discovery</h3>
    <p>We start by understanding your business model, goals, and technical needs through deep consultation and analysis.</p>
  </div>
  ...
  <div className="process-step">
    ...
    <h3>Strategy</h3>
    <p>Our Employee crafts a tailored digital roadmap — selecting the right technologies, architecture, and development plan aligned with your vision.</p>
  </div>
  ...
  <div className="process-step">
    ...
    <p>We bring the strategy to life with clean code, AI-powered systems, scalable infrastructure, and seamless deployment.</p>
  </div>
</div>
        </div>
      </div>
