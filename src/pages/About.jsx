...
import { Award, MapPin, Phone, Clock, Linkedin, Mail, Twitter, Facebook } from 'lucide-react';
              ...
              <div className="flex items-start space-x-8">
                ...
                <div className="flex-1 pt-2">
                  <div className="bg-gray-100 rounded-lg p-6">
                    <h3 className="text-xl font-semibold text-blue-600 mb-2">Future Growth</h3>
                    <p className="text-gray-600">
